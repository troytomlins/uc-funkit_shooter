TODO:  (P = Priority, E = Extra)
 P- Reduce lives when player gets hit 
	P- Create an end game text scroll when a player loses
		E- include how many lives were remaining for the winner
		E- have the option to play again
	E- Have the blue LED show lives remaining 
  - Give the player a certain amount of invulnerability time after getting hit
...
Getting hit:
 - Contact with a moving shell means you lose a life.  TO BE IMPLEMENTED
 - You have three lives, losing all lives means you lose the game. TO BE IMPLEMENTED
...
Lives:
 ...
 - When you run out of lives, you lose the game TO BE IMPLEMENTED
